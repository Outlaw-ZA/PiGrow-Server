...
export const UpsertPhaseEnvironmentSchema = Type.Object({
  ...
  humidityMin: NullableNumber,
  humidityTarget: NullableNumber,
  phMax: Type.Optional(Type.Union([Type.Number({ multipleOf: 0.01, maximum: 14 }), Type.Null()])),
  phMin: Type.Optional(Type.Union([Type.Number({ multipleOf: 0.01, maximum: 14 }), Type.Null()])),
  phTarget: Type.Optional(
    Type.Union([Type.Number({ multipleOf: 0.01, maximum: 14 }), Type.Null()]),
  ),
  tempMax: NullableNumber,
  tempMin: NullableNumber,
  tempTarget: NullableNumber,
